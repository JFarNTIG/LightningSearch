...
// Qt MOC source file
#include "ui/moc_CFilterNameWidget.cpp"

CFilterNameWidget::CFilterNameWidget(QWidget *parent)
...
IFilter *CFilterNameWidget::createFilter()
{
    ...
    return new CFilterName(text, !caseSensitive, wholeMatch, regexMode);
}